  ...
  function renderTodos() {
    ...
    todos.forEach((todo, index) => {
      ...
      <div class="right-section">
        <button class="edit-btn"><i class="fa fa-edit" style="font-size:20px"></i> Edit</button>
        <button class="delete-btn"> <i class="fa fa-trash-o" style="font-size:20px"></i> Delete</button>
      </div>
    `;
